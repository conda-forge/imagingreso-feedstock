About imagingreso-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/imagingreso-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5461&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/imagingreso-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `imagingreso` can be installed with `conda`:
...
```
mamba install imagingreso
```

It is possible to list all of the versions of `imagingreso` available on your platform with `conda`:
...
```
mamba search imagingreso --channel conda-forge
```
...
mamba repoquery search imagingreso --channel conda-forge

# List packages depending on `imagingreso`:
mamba repoquery whoneeds imagingreso --channel conda-forge

# List dependencies of `imagingreso`:
mamba repoquery depends imagingreso --channel conda-forge
```
